...
<SubscribeSectionDownloadable thumbnail="/downloadable-thumbnails/intro-to-ssgs-thumbnail.png" downloadable={true}>
    <h2>Free PDF version of this article</h2>
    <p> If you are out of time, get the PDF version of this article, along with other resources, straight to your inbox.</p></SubscribeSectionDownloadable>
