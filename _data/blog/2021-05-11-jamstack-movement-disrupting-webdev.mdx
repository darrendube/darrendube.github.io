...
This approach has its advantages - they tend to be <b>easier</b> for the average person to run, they can be <b>highly dynamic</b> because the page is only built at load time, and they are <b>less reliant</b> on third-party providers for synamic functionality - since they run on a literal server!
...
The M part of Jamstack is probably it's most important part. It stands for **Mark-up**. This means that Static HTML files are served to the user. 
